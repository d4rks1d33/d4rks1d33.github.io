...
class $e4abeb5bcdcc88f9$export$e09e2fba47679cf2 extends (0, $3KHBw.ROM) {
    constructor(){
        ...
        this.TEXT_START = (0, (/*@__PURE__*/$parcel$interopDefault($iwKFf))).text_start;
        this.ENTRY = (0, (/*@__PURE__*/$parcel$interopDefault($iwKFf))).entry;
        this.DATA_START = (0, (/*@__PURE__*/$parcel$interopDefault($iwKFf))).data_start;
        this.ROM_DATA = (0, (/*@__PURE__*/$parcel$interopDefault($iwKFf))).data;
        this.ROM_TEXT = (0, (/*@__PURE__*/$parcel$interopDefault($iwKFf))).text;
    }
...
parcelRegister("iwKFf", function(module, exports) {
...
//# sourceMappingURL=esp32.a60671db.js.map
